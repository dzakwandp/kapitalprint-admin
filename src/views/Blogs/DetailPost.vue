    ...
    <div class="mx-4 mt-2">
        ...
        <v-row v-else>
            ...
            <v-col cols="9">
                ...
                <v-card class="pa-4" color="green-darken-4" variant="tonal">
                    <v-text-field v-model="postTitle" label="Nama Produk" required></v-text-field>
                    <v-row align="center">
                        <v-col cols="10">
                            ...
                            <v-dialog v-model="dialogdel" width="auto">
                                ...
                                <v-card>
                                    ...
                                    <v-card-actions class="justify-space-around">
                                        ...
                                        <v-btn color="green-darken-4" variant="tonal" @click="deletePost()">Yakin</v-btn>
                                    </v-card-actions>
                                </v-card>
                            </v-dialog>
                        </div>
                            ...
                            <v-dialog v-model="dialogup" width="auto">
                                ...
                                <v-card>
                                    ...
                                    <v-card-actions class="justify-space-around">
                                        ...
                                        <v-btn color="green-darken-4" variant="tonal" @click="updatePost()">Yakin</v-btn>
                                    </v-card-actions>
                                </v-card>
                            </v-dialog>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async updatePost() {
            try {
                const response = await axios.put(this.apiUrl + 'api/blogs/' + this.$route.params.id, {
        ...
        async deletePost() {
            try {
                const response = await axios.delete(this.apiUrl + 'api/blogs/' + this.$route.params.id)
                console.log(response)
                this.dialog = false
                alert(response.data.message);
                this.$router.push("/blog");
    ...
    async mounted() {
        try {
            const response = await axios.get(this.apiUrl + "api/blogs/" + this.$route.params.id);
